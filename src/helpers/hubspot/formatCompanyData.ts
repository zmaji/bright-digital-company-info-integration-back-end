...
export const formatCompanyData = async (companyData) => {
  const data = {
    ...
    legal_name: companyData.legal_name ? companyData.legal : '',
    ...
    discontinuation_date: companyData.discontinuation_date ? formatDateToUTC(companyData.discontinuation_date.month, companyData.discontinuation_date.day, companyData.discontinuation_date.year) : '',
    continuation_date: companyData.continuation_date ? formatDateToUTC(companyData.continuation_date.month, companyData.continuation_date.day, companyData.continuation_date.year) : '',
    ...
    secondary_sbi_code2: companyData.secondary_sbi_code2 ? companyData.secondary_sbi_code : '',
